...
(assert (str.contains x_12 "\x3c\x62\x72\x3e"))
(assert (str.prefixof "\x3c\x63\x65\x6e\x74\x65\x72\x3e" x_12))
(assert (str.suffixof "\x5c\x6e\x3c\x2f\x63\x65\x6e\x74\x65\x72\x3e\x5c\x6e" x_12))
(assert (>= (str.indexof x_12 "\x3c\x61\x20\x68\x72\x65\x66\x3d\x27\x73\x75\x62\x6d\x69\x74\x2e\x70\x68\x70\x3f\x73\x74\x79\x70\x65\x3d\x6e\x27\x3e" 0) 0))
(assert (= (str.len x_12) (+ (str.len sigmaStar_0) (str.len sigmaStar_1) (str.len sigmaStar_2) 112)))
