...
(assert (str.contains x_29 "\x5c\x3c\x53\x43\x52\x49\x50\x54"))
(assert (str.prefixof x_14 literal_13))
(assert (str.suffixof "\x5c\x6e" x_29))
(assert (>= (str.indexof x_29 "\x5c\x3c\x53\x43\x52\x49\x50\x54" 0) 0))
(assert (>= (str.len x_29) 10))
(check-sat)
(exit)