...
(assert (str.prefixof literal_4 x_14))
...
(assert (= x_15 (str.substr x_14 5 10)))
(assert (= x_16 (str.replace x_14 "\x3c\x2f\x61\x3e" "\x5c\x3c\x2f\x61\x3e")))
(assert (= x_17 (str.len x_16)))
(assert (= x_20 (str.at x_16 0)))
(assert (= (str.indexof x_14 "\x3c\x62\x72\x3e" 0) 0))
(assert (= x_18 (str.++ x_14 "\x3c\x73\x74\x72\x6f\x6e\x67\x3e")))
(assert (= x_19 (str.to.int (str.substr x_14 0 1))))
(assert (str.contains x_18 "\x3c\x73\x74\x72\x6f\x6e\x67\x3e"))
(assert (= (int.to.str x_19) "34"))
(check-sat)
(exit)