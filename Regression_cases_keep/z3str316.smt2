...
(assert (= x_27 (str.++ x_26 "\x5c\x72\x5c\x6e")))
(assert (= (str.len x_27) (+ (str.len x_26) 4)))
(assert (= (str.substr x_27 0 10) "\x3c\x74\x64\x20\x63\x6c\x61\x73\x73\x3d"))
(assert (= (str.at x_27 0) "\x3c"))
(assert (str.contains x_27 "\x5c\x72\x5c\x6e"))
(assert (= (str.to.int x_13) 1))
(assert (= (int.to.str (str.len x_26)) (str.++ "\x31\x33\x34")))
(check-sat)
(exit)