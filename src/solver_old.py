...
custom_temp_dir = r"/home/cass/Webstorm_project/0213/results/Regression_cases"  # 临时目录
...
def run_solver(instance, solver, type):
    ...
    out, err, time = run_command(
        "timeout " + str(settings.timeout + 1) + " bash -c \'/home/cass/Webstorm_project/0213/" + solver + "/bin/z3 " + op + " " + outFile.name + "\'")
