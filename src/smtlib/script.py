...
class SMTLIBScript(collections.abc.MutableSequence):
    def __init__(self, *args):
        self._storage = list(args)
        import src.smtlib.theories.core as core
...
class SExpr(collections.abc.MutableSequence):
    def __init__(self, *args):
        self._storage = list(args)
